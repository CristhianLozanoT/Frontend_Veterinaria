...
class AdminMascotasPage extends StatefulWidget {
  const AdminMascotasPage({super.key});

  @override
  State<AdminMascotasPage> createState() => _AdminMascotasPageState();
}

class _AdminMascotasPageState extends State<AdminMascotasPage> {
  ...
  void _deletePet(int id) {
    showDialog(
      context: context,
      builder: (_) => AlertDialog(
        title: const Text("Eliminar Mascota"),
        content: const Text("¿Seguro que deseas eliminar esta mascota?"),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(context),
            child: const Text("Cancelar"),
